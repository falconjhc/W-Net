...
input_args = [
    ...
    #'/Data_HDD/Harric/ChineseCharacterExp/tfModels_WNet/checkpoint/Exp20190126-WNet-DenseMixer-NonAdaIN_StylePf50_ContentPf32_GenEncDec6-Des5@Lyr3_DisMdy6conv/',
    ...
    '--experiment_id','20190520-WNet-DenseMixer-BN_StylePf50_ContentPf64',# experiment name prefix
