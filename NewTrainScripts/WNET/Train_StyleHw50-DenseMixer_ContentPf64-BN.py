...
input_args = [
    ...
    # '/Data_HDD/Harric/ChineseCharacterExp/tfModels_WNet/checkpoint/Exp20190126-WNet-DenseMixer-NonAdaIN_StyleHw50_ContentPf32+Hw32_GenEncDec6-Des5@Lyr3_DisMdy6conv/',
    ...
    '--experiment_id','20190520-WNet-DenseMixer-BN_StyleHw50_ContentPf64',# experiment name prefix
    ...
    '--Pixel_Reconstruction_Penalty','10',
    '--Lconst_content_Penalty','1',
    '--Lconst_style_Penalty','1',
    '--Discriminative_Penalty', '5',
    '--Discriminator_Categorical_Penalty', '3',
    '--Discriminator_Gradient_Penalty', '3',
    ...
    '--Feature_Penalty_True_Fake_Target', '10',
    '--Feature_Penalty_Style_Reference','0.1',
    '--Feature_Penalty_Content_Prototype','0.1']
