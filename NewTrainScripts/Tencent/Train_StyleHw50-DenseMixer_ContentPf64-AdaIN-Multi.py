...
data_path_root = '/data/harric/WNet/'
model_log_path_root = '/data/harric/WNet/'
...
input_args = [
    ...
    '--experiment_id','20190423-WNet-DenseMixer-AdaIN-Multi_StyleHw50_ContentPf64',# experiment name prefix
