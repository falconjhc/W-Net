...
input_args = [
    ...
    #'/Data_HDD/Harric/ChineseCharacterExp/tfModels_WNet/checkpoint/Exp20190127-WNet-NonAdaIN_StyleHP444_ContentPf32+Hw32_GenEncDec6-Res9@Lyr3_DisMdy6conv/',
    ...
    '--experiment_id','20190129-WNet-ResidualMixer-NonAdaIN_StyleHP444_ContentPf32+Hw32',# experiment name prefix
    '--experiment_dir','tfModels2019_WNet/', # model saving location
    '--log_dir','tfLogs2019_WNet_More/',# log file saving location
