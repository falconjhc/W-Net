...
input_args = [
    ...
    '/Data_HDD/Harric/ChineseCharacterExp/tfModels_FeatureExtractor/checkpoint/Exp20190106_FeatureExtractor_Content_HW300Pf80_vgg16net/variables',
    ...
    '--image_filters','1',
    '--experiment_id','20190119_FeatureExtractor_Content_HW300Pf144',
    '--train_resume_mode','0',
