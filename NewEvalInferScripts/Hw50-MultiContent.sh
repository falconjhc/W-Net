...
python Hw50_MultiContent_InferEval_Script_TrainStyle.py --style_input_number=4  --evaluating_generator_dir=$load_dir
python Hw50_MultiContent_InferEval_Script_TrainStyle.py --style_input_number=1  --evaluating_generator_dir=$load_dir
python Hw50_MultiContent_InferEval_Script_TestStyle.py --style_input_number=4  --evaluating_generator_dir=$load_dir
python Hw50_MultiContent_InferEval_Script_TestStyle.py --style_input_number=1  --evaluating_generator_dir=$load_dir