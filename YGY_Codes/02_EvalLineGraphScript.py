...
def main():
    ...
    draw_line_func_for_pixel(draw_y=pixel_same_pdar_list,
                             ...
                             fig_saving_info='W-Net' + '-' + checking_dataset + '-' + checking_mode)
    draw_line_func_for_pixel(draw_y=pixel_random_content_l1_list,
                             style_num=style_num_list,
                             exp_name_list=exp_full_list_structured,
                             y_axis_name='RandomContent-Pixel-L1',
                             fig_saving_info='W-Net' + '-' + checking_dataset + '-' + checking_mode)
    draw_line_func_for_pixel(draw_y=pixel_random_content_mse_list,
                             style_num=style_num_list,
                             exp_name_list=exp_full_list_structured,
                             y_axis_name='RandomContent-Pixel-MSE',
                             fig_saving_info='W-Net' + '-' + checking_dataset + '-' + checking_mode)
    draw_line_func_for_pixel(draw_y=pixel_random_content_pdar_list,
                             style_num=style_num_list,
                             exp_name_list=exp_full_list_structured,
                             y_axis_name='RandomContent-Pixel-PDAR',
                             fig_saving_info='W-Net' + '-' + checking_dataset + '-' + checking_mode)
    draw_line_func_for_pixel(draw_y=pixel_random_style_l1_list,
                             style_num=style_num_list,
                             exp_name_list=exp_full_list_structured,
                             y_axis_name='RandomStyle-Pixel-L1',
                             fig_saving_info='W-Net' + '-' + checking_dataset + '-' + checking_mode)
    draw_line_func_for_pixel(draw_y=pixel_random_style_mse_list,
                             style_num=style_num_list,
                             exp_name_list=exp_full_list_structured,
                             y_axis_name='RandomStyle-Pixel-MSE',
                             fig_saving_info='W-Net' + '-' + checking_dataset + '-' + checking_mode)
    draw_line_func_for_pixel(draw_y=pixel_random_style_pdar_list,
                             style_num=style_num_list,
                             exp_name_list=exp_full_list_structured,
                             y_axis_name='RandomStyle-Pixel-PDAR',
                             fig_saving_info='W-Net' + '-' + checking_dataset + '-' + checking_mode)


    # draw lines of deep features (mse)
    ...
    draw_line_func_for_deep_feature(draw_y=mse_true_fake_avg_list,
     ...
     # draw lines of deep features (vn)
