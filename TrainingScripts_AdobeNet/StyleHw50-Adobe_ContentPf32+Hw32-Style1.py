...
input_args = [
 ...
 #    '/Data_HDD/Harric/ChineseCharacterExp/tfModels_AdobeNet/checkpoint/Exp20190122-AdobeNet-Style1_StyleHw50_ContentPf32+Hw32_GenEncDec6_DisMdy6conv/',
    ...
    '--experiment_id','20190129-AdobeNet-Style1_StyleHw50_ContentPf32+Hw32',# experiment name prefix
    '--experiment_dir','tfModels2019_AdobeNet/', # model saving location
    '--log_dir','tfLogs2019_AdobeNet_Hw50/',# log file saving location
