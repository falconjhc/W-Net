...
input_args = [
    ...
    #'/Data_HDD/Harric/ChineseCharacterExp/tfModels_WNet/checkpoint/Exp20181225-AdaIN-Multi_StylePf50_ContentPf32_GenEncDec6-Res5@Lyr3_DisMdy6conv',
    ...
    '--experiment_id','20190108-WNet-AdaIN-Multi_StylePf50_ContentPf32',# experiment name prefix
