...
input_args = [
    ...
    #'/Data_HDD/Harric/ChineseCharacterExp/tfModels_WNet/checkpoint/Exp20181206_StyleHw100_ContentPf32+Hw32_GenEncDec6-Res7@Lyr3_DisMdy6conv',
    '--debug_mode','0',
    ...
    '--experiment_id','20181226-WNet-NonAdaIN_StyleHw100_ContentPf32+Hw32',# experiment name prefix
