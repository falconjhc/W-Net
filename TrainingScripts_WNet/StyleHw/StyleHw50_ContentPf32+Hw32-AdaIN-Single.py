...
input_args = [
    ...
    #'/Data_HDD/Harric/ChineseCharacterExp/tfModels_WNet/checkpoint/Exp20181225-AdaIN-Single_StyleHw50_ContentPf32+Hw32_GenEncDec6-Res5@Lyr3_DisMdy6conv',
    '--debug_mode','0',
    ...
    '--experiment_id','20190108-WNet-AdaIN-Single_StyleHw50_ContentPf32+Hw32',# experiment name prefix
