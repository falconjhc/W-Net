...
print(content_known_unknown)
print(style_known_unknown)
print(style_input_number)
print(evaluating_generator_dir)
print("################################################################################")
print("################################################################################")
print("################################################################################")
...
known_content_file_list.append('../TrainTestFileList/PrintedData/Char_0_3754_GB2312L1_Printed64_Simplified_Train.txt')

## unknown content
unknown_content_file_list=list()
unknown_content_file_list.append('../TrainTestFileList/PrintedData/Char_0_3754_GB2312L1_Printed64_Simplified_Test.txt')
