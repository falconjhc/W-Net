...
file_list_txt_true_style.append('../EvaluationDataFileLists/PrintedData/ContentChar_BlancaPython_Font_0_49_GB2312L1.txt')

# input style setting
targeted_style_input_txt='../ContentTxt/StyleChars_Paintings_20.txt'
file_list_txt_input_style=list()
file_list_txt_input_style.append('../EvaluationDataFileLists/PrintedData/StyleChar_Paintings_Font_0_49_GB2312L1.txt')
