...
def main():
    ...
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[0], color='lightcoral', marker='o', label='Block1-Layer2-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[1], color='chocolate', marker='o', label='Block2-Layer2-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[2], color='gold', marker='o', label='Block3-Layer3-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[3], color='lime', marker='o', label='Block4-Layer3-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[4], color='darkslategrey', marker='o', label='Block5-Layer3-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[5], color='cornflowerblue', marker='o', label='Block6-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[6], color='hotpink', marker='o', label='Block7-MSE')
    rotate_list = list(map(lambda n: n + 0.6, rotate_list))
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[0], color='darkred', marker='*', label='Block1-Layer2-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[1], color='bisque', marker='*', label='Block2-Layer2-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[2], color='y', marker='*', label='Block3-Layer3-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[3], color='lightgreen', marker='*', label='Block4-Layer3-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[4], color='black', marker='*', label='Block5-Layer3-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[5], color='slategray', marker='*', label='Block6-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[6], color='lightpink', marker='*', label='Block7-VN')
    rotate_list = list(map(lambda n: n - 0.3, rotate_list))
    ...
    plt.plot(translate_list, translate0_output_feature_style_mse_list[0], color='lightcoral', marker='o', label='Block1-Layer2-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[1], color='chocolate', marker='o', label='Block2-Layer2-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[2], color='gold', marker='o', label='Block3-Layer3-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[3], color='lime', marker='o', label='Block4-Layer3-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[4], color='darkslategrey', marker='o', label='Block5-Layer3-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[5], color='cornflowerblue', marker='o', label='Block6-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[6], color='hotpink', marker='o', label='Block7-MSE')
    translate_list = list(map(lambda n: n + 0.6, translate_list))
    plt.plot(translate_list, translate0_output_feature_style_vn_list[0], color='darkred', marker='*', label='Block1-Layer2-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[1], color='bisque', marker='*', label='Block2-Layer2-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[2], color='y', marker='*', label='Block3-Layer3-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[3], color='lightgreen', marker='*', label='Block4-Layer3-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[4], color='black', marker='*', label='Block5-Layer3-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[5], color='slategray', marker='*', label='Block6-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[6], color='lightpink', marker='*', label='Block7-VN')
    translate_list = list(map(lambda n: n - 0.3, translate_list))
    ...
    translate_list = list(map(lambda n: n - 0.3, translate_list))
    plt.plot(translate_list, translate1_output_feature_style_mse_list[0], color='lightcoral', marker='o', label='Block1-Layer2-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[1], color='chocolate', marker='o', label='Block2-Layer2-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[2], color='gold', marker='o', label='Block3-Layer3-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[3], color='lime', marker='o', label='Block4-Layer3-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[4], color='darkslategrey', marker='o', label='Block5-Layer3-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[5], color='cornflowerblue', marker='o', label='Block6-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[6], color='hotpink', marker='o', label='Block7-MSE')
    translate_list = list(map(lambda n: n + 0.6, translate_list))
    plt.plot(translate_list, translate1_output_feature_style_vn_list[0], color='darkred', marker='*', label='Block1-Layer2-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[1], color='bisque', marker='*', label='Block2-Layer2-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[2], color='y', marker='*', label='Block3-Layer3-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[3], color='lightgreen', marker='*', label='Block4-Layer3-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[4], color='black', marker='*', label='Block5-Layer3-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[5], color='slategray', marker='*', label='Block6-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[6], color='lightpink', marker='*', label='Block7-VN')
    plt.axis([-translate_dist_max, translate_dist_max, -0.01, 1.05])
