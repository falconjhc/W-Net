...
def main():
    ...
    plt.plot(rotate_list, rotate_output_pixel_l1_list, color='deepskyblue', label='Pixel-L1')
    plt.plot(rotate_list, rotate_output_pixel_mse_list, color='darkgoldenrod', label='Pixel-MSE')
    plt.plot(rotate_list, rotate_output_pixel_pdar_list, color='lightgoldenrodyellow', label='Pixel-PDAR')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[0], color='lightgrey', label='Block1-Layer2-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[1], color='turquoise', label='Block2-Layer2-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[2], color='plum', label='Block3-Layer3-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[3], color='yellow', label='Block4-Layer3-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[4], color='limegreen', label='Block5-Layer3-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[5], color='olive', label='Block6-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[6], color='turquoise', label='Block7-MSE')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[0], color='red', label='Block1-Layer2-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[1], color='darkviolet', label='Block2-Layer2-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[2], color='darkgreen', label='Block3-Layer3-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[3], color='maroon', label='Block4-Layer3-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[4], color='orange', label='Block5-Layer3-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[5], color='mediumaquamarine', label='Block6-VN')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[6], color='black', label='Block7-VN')
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(translate_list, translate0_output_pixel_l1_list, color='deepskyblue', label='Pixel-L1')
    plt.plot(translate_list, translate0_output_pixel_mse_list, color='darkgoldenrod', label='Pixel-MSE')
    plt.plot(translate_list, translate0_output_pixel_pdar_list, color='lightgoldenrodyellow', label='Pixel-PDAR')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[0], color='lightgrey', label='Block1-Layer2-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[1], color='turquoise', label='Block2-Layer2-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[2], color='plum', label='Block3-Layer3-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[3], color='yellow', label='Block4-Layer3-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[4], color='limegreen', label='Block5-Layer3-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[5], color='olive', label='Block6-MSE')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[6], color='turquoise', label='Block7-MSE')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[0], color='red', label='Block1-Layer2-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[1], color='darkviolet', label='Block2-Layer2-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[2], color='darkgreen', label='Block3-Layer3-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[3], color='maroon', label='Block4-Layer3-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[4], color='orange', label='Block5-Layer3-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[5], color='mediumaquamarine', label='Block6-VN')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[6], color='black', label='Block7-VN')
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(translate_list, translate1_output_pixel_l1_list, color='deepskyblue', label='Pixel-L1')
    plt.plot(translate_list, translate1_output_pixel_mse_list, color='darkgoldenrod', label='Pixel-MSE')
    plt.plot(translate_list, translate1_output_pixel_pdar_list, color='lightgoldenrodyellow', label='Pixel-PDAR')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[0], color='lightgrey', label='Block1-Layer2-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[1], color='turquoise', label='Block2-Layer2-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[2], color='plum', label='Block3-Layer3-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[3], color='yellow', label='Block4-Layer3-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[4], color='limegreen', label='Block5-Layer3-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[5], color='olive', label='Block6-MSE')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[6], color='turquoise', label='Block7-MSE')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[0], color='red', label='Block1-Layer2-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[1], color='darkviolet', label='Block2-Layer2-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[2], color='darkgreen', label='Block3-Layer3-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[3], color='maroon', label='Block4-Layer3-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[4], color='orange', label='Block5-Layer3-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[5], color='mediumaquamarine', label='Block6-VN')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[6], color='black', label='Block7-VN')
