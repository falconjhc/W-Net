...
def main():
    ...
    plt.plot(rotate_list, rotate_output_entropy_list, color='orange', label='Entropy')
    plt.plot(rotate_list, rotate_output_wasserstein_list, color='black', label='W-D')
    # plt.title('Pixel-Level Discrepancy w.r.t. Image Rotating')
    plt.xlabel('Rotating Angle', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './Pixel-Discrepancy-Rotation.pdf'))

    plt.figure(figsize=(10,5))
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[0], color='red', label='Layer1')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[1], color='orange', label='Layer2')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[2], color='yellow', label='Layer3')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[3], color='green', label='Layer4')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[4], color='blue', label='Layer5')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[5], color='cyan', label='Layer6')
    plt.plot(rotate_list, rotate_output_feature_style_mse_list[6], color='violet', label='Layer7')
    # plt.title('Deep Feature Discrepancy w.r.t. Image Rotating')
    plt.xlabel('Rotating Angle', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './DeepFeature-MSE-Discrepancy-Rotation.pdf'))

    plt.figure(figsize=(10,5))
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[0], color='red', label='Layer1')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[1], color='orange', label='Layer2')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[2], color='yellow', label='Layer3')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[3], color='green', label='Layer4')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[4], color='blue', label='Layer5')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[5], color='cyan', label='Layer6')
    plt.plot(rotate_list, rotate_output_feature_style_vn_list[6], color='violet', label='Layer7')
    # plt.title('Deep Feature Discrepancy w.r.t. Image Rotating')
    plt.xlabel('Rotating Angle', fontsize=20)
    plt.ylabel('RelDiscrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './DeepFeature-VN-Discrepancy-Rotation.pdf'))
    ...
    plt.plot(translate_list, translate0_output_entropy_list, color='orange', label='Entropy')
    plt.plot(translate_list, translate0_output_wasserstein_list, color='black', label='W-D')
    # plt.title('Pixel-Level Discrepancy w.r.t. Image Vertical Translate')
    plt.xlabel('Vertical Translate Pixel', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './Pixel-Discrepancy-VerticalTranslation.pdf'))

    plt.figure(figsize=(10,5))
    plt.plot(translate_list, translate0_output_feature_style_mse_list[0], color='red', label='Layer1')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[1], color='orange', label='Layer2')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[2], color='yellow', label='Layer3')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[3], color='green', label='Layer4')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[4], color='blue', label='Layer5')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[5], color='cyan', label='Layer6')
    plt.plot(translate_list, translate0_output_feature_style_mse_list[6], color='violet', label='Layer7')
    # plt.title('Deep Feature Discrepancy w.r.t. Image Vertical Translation')
    plt.xlabel('Vertical Translate Pixel', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './DeepFeature-MSE-Discrepancy-VerticalTranslation.pdf'))

    plt.figure(figsize=(10,5))
    plt.plot(translate_list, translate0_output_feature_style_vn_list[0], color='red', label='Layer1')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[1], color='orange', label='Layer2')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[2], color='yellow', label='Layer3')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[3], color='green', label='Layer4')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[4], color='blue', label='Layer5')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[5], color='cyan', label='Layer6')
    plt.plot(translate_list, translate0_output_feature_style_vn_list[6], color='violet', label='Layer7')
    # plt.title('Deep Feature Discrepancy w.r.t. Image Vertical Translation')
    plt.xlabel('Vertical Translate Pixel', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './DeepFeature-VN-Discrepancy-VerticalTranslation.pdf'))
    ...
    plt.plot(translate_list, translate1_output_entropy_list, color='orange', label='Entropy')
    plt.plot(translate_list, translate1_output_wasserstein_list, color='black', label='W-D')
    # plt.title('Pixel-Level Discrepancy w.r.t. Image Horizontal Translate')
    plt.xlabel('Horizontal Translate Pixel', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './Pixel-Discrepancy-HorizontalTranslation.pdf'))

    plt.figure(figsize=(10,5))
    plt.plot(translate_list, translate1_output_feature_style_mse_list[0], color='red', label='Layer1')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[1], color='orange', label='Layer2')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[2], color='yellow', label='Layer3')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[3], color='green', label='Layer4')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[4], color='blue', label='Layer5')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[5], color='cyan', label='Layer6')
    plt.plot(translate_list, translate1_output_feature_style_mse_list[6], color='violet', label='Layer7')
    # plt.title('Deep Feature Discrepancy w.r.t. Image Horizontal Translation')
    plt.xlabel('Horizontal Translate Pixel', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './DeepFeature-MSE-Discrepancy-HorizontalTranslation.pdf'))

    plt.figure(figsize=(10,5))
    plt.plot(translate_list, translate1_output_feature_style_vn_list[0], color='red', label='Layer1')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[1], color='orange', label='Layer2')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[2], color='yellow', label='Layer3')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[3], color='green', label='Layer4')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[4], color='blue', label='Layer5')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[5], color='cyan', label='Layer6')
    plt.plot(translate_list, translate1_output_feature_style_vn_list[6], color='violet', label='Layer7')
    # plt.title('Deep Feature Discrepancy w.r.t. Image Horizontal Translation')
    plt.xlabel('Horizontal Translate Pixel', fontsize=20)
    plt.ylabel('Discrepancy', fontsize=20)
    plt.legend(fontsize=15)
    # plt.show()
    plt.savefig(os.path.join(saving_path_dir, './DeepFeature-VN-Discrepancy-HorizontalTranslation.pdf'))
