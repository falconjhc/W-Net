...
input_args = [
    ...
    '--experiment_id','20190122-ResMixer-5-SimpleMixer-Style4-AdaIN_StylePf50_ContentPf32',# experiment name prefix
    '--experiment_dir','tfModels_AdobeNet/', # model saving location
    '--log_dir','tfLogsNew_AdobeNet_Pf50/',# log file saving location
