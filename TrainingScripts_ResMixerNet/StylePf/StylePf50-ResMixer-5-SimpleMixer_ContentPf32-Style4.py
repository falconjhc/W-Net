...
input_args = [
    ...
    '--experiment_id','20190129-ResMixer-5-SimpleMixer-Style4_StylePf50_ContentPf32',# experiment name prefix
    '--experiment_dir','tfModels2019_ResMixerNet/', # model saving location
    '--log_dir','tfLogs2019_ResMixerNet_Pf50/',# log file saving location
