...
input_args = [
    ...
    '--experiment_id','20190122-ResMixer-5-SimpleMixer-Style1-AdaIN_StyleHw50_ContentPf32+Hw32',# experiment name prefix
    '--experiment_dir','tfModels_AdobeNet/', # model saving location
    '--log_dir','tfLogsNew_AdobeNet_Hw50/',# log file saving location
